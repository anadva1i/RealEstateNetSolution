(function ($) {
    ...
    if ($('.feature_property_slider').children().length > 3) {
        ...
        $('.feature_property_slider').children().css("width", "32%")
    }

    /*  Testimonial-Slider-Owl-carousel  */
    if ($('.testimonial_grid_slider').children().length > 1) {
        console.log("here")
    ...
    if ($('.team_slider').children().length > 1) {
        console.log("here")
    ...
    if ($('.best_property_slider').children().length > 1) {
        console.log("here")
    ...
    /*  Team-Slider-Owl-carousel  */
    if ($('.feature_property_home3_slider').children().length > 1) {
        console.log("here")
    ...
    /*  Team-Slider-Owl-carousel  */
    if ($('.feature_property_home6_slider').children().length > 1) {
        console.log("here")
    ...
    /*  Team-Slider-Owl-carousel  */
    if ($('.our_agents_home6_slider').children().length > 1) {
        console.log("here")
    ...
    /*  Testimonial-Slider-Owl-carousel  */
    if ($('.testimonial_slider_home9').children().length > 1) {
        console.log("here")
    ...
    if ($('.sidebar_feature_property_slider').children().length > 1) {
        console.log("here")
    ...
    /*  One-Grid-Owl-carousel  */
if ($('.listing_single_property_slider').children().length > 1) {
    console.log("here")
    ...
    /*  One-Grid-Owl-carousel  */
    if ($('.fp_single_item_slider').children().length > 1) {
    console.log("here")
...
if ($(".banner-style-one").children().length > 1) {
    console.log("here")
    ...
    /*  Team-Slider-Owl-carousel  */
if ($('.single_product_slider').children().length > 1) {
    console.log("here")
